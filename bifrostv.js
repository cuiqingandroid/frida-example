...
setImmediate(function () {
    var getsigature = function(){
        //App.Companion.getApp().getPackageManager().getPackageInfo(App.Companion.getApp().getPackageName(), 64).signatures[0].toByteArray();
        var clzApp = Java.use("com.github.dawndiy.bifrostv.App");
        console.log(clzApp.Companion.value);
        var app = clzApp.Companion.value.getApp();
        console.log(app);
        // var signingInfo = app.getPackageManager().getPackageInfo("com.github.dawndiy.bifrostv", 134217728).signingInfo;
        // var arr = signingInfo.value.getApkContentsSigners()[0].toByteArray();
        // 28以下
        var signatures = app.getPackageManager().getPackageInfo("com.github.dawndiy.bifrostv", 64).signatures;
        var arr = signatures.value[0].toByteArray();
        var clzArr = Java.use("java.util.Arrays");
        console.log(clzArr.toString(arr));
        return;
